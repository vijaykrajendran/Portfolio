      ...
      <div className="fade-in divide-y-2 divide-gray-100 dark:divide-gray-800">
        ...
        <div className="container py-12">
          ...
          {k8sCerts.length > 0 && (
            <div className="mb-12">
              <div className="mb-6 flex items-center">
                ...
                <h2 className="ml-3 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-3">
            <div className="rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-center text-white">
              <div className="text-4xl font-bold">{certifications.length}</div>
              <div className="text-sm opacity-90">Total Certifications</div>
            </div>
            <div className="rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 p-6 text-center text-white">
              <div className="text-4xl font-bold">{k8sCerts.length}</div>
              <div className="text-sm opacity-90">Kubernetes Certs</div>
            </div>
            <div className="rounded-xl bg-gradient-to-br from-green-500 to-green-600 p-6 text-center text-white">
          ...
          <div className="mt-8 rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-800 dark:bg-yellow-900/20">
            <p className="text-sm text-yellow-800 dark:text-yellow-200">
              <span className="font-medium">Note:</span> Remember to add your actual certification badge images to{' '}
              <code className="rounded bg-yellow-100 px-1 dark:bg-yellow-800">/public/static/certifications/</code>{' '}
              and update the credential URLs and IDs in{' '}
              <code className="rounded bg-yellow-100 px-1 dark:bg-yellow-800">config/certifications.ts</code>
            </p>
          </div>
        </div>
      </div>
